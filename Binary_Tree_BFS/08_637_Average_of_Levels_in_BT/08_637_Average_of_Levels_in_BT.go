...
/* Задача Среднее значение уровней в двоичном дереве
Дан корень двоичного дерева. Вернуть среднее значение узлов на каждом уровне в виде массива. Принимаются ответы, отличающиеся от фактического не более чем на 10^-5.
Ограничения:
